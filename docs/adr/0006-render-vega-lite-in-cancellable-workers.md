...
The finished document and PDF export reuse the same sanitized SVG snapshot. Vega-Lite is not rerun in the export window, and Mermaid/PlantUML diagram optimization does not alter visualization specifications.
