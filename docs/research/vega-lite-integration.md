...
> 2026-09-10 更新：下文的首版语法白名单、不确定表达式禁用及固定尺寸建议已由 [ADR 0027](../adr/0027-preserve-official-vega-lite-syntax.md) 取代。当前实现使用官方语法校验，支持内联命名数据、参数、变换及容器尺寸适配，保留资源访问和运行预算边界。本文其余内容保留为当时的调研背景。
