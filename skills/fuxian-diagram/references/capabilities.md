...
- Vega-Lite authored text tooltips are preserved in SVG snapshots and displayed on hover or keyboard focus in reading, paper, and focused views. This does not enable live data filtering or brushing. PDF and static images retain visible labels but have no hover interaction.
